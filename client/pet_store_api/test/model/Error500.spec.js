...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PetStoreApi.Error500();
  });
  ...
  describe('Error500', function() {
    it('should create an instance of Error500', function() {
      ...
      //var instane = new PetStoreApi.Error500();
      //expect(instance).to.be.a(PetStoreApi.Error500);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new PetStoreApi.Error500();
