...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PetStoreApi.ResponsePegination();
  });
  ...
  describe('ResponsePegination', function() {
    it('should create an instance of ResponsePegination', function() {
      // uncomment below and update the code to test ResponsePegination
      //var instane = new PetStoreApi.ResponsePegination();
      //expect(instance).to.be.a(PetStoreApi.ResponsePegination);
    });
    ...
    it('should have the property currentPage (base name: "current_page")', function() {
      ...
      //var instance = new PetStoreApi.ResponsePegination();
